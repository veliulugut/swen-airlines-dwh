create procedure job_flight_incident(load_type text DEFAULT 'full'::text)
    language plpgsql
as
$$
DECLARE
    v_proc_name       CONSTANT TEXT := 'JOB_FLIGHT_INCIDENT';
    V_TABLE          CONSTANT TEXT := 'ft_flight_incident';
    V_TABLE_1           CONSTANT TEXT := 'str_flight_incident';
    V_TABLE_2          CONSTANT TEXT := 'tr_flight_incident';
...
alter procedure job_flight_incident(text) owner to admin;
